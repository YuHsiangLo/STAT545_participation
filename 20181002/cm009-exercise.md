...
``` r
write_delim(iris, path = "iris.txt", delim = "$")
```
...
``` r
gather(lotr_untidy, key = "Gender", value = "Word", Female:Male)  # the same
```
...
``` r
gather(lotr_untidy, key = "Gender", value = "Word", contains("ale"))  # also the same
```
...
```
    ...
    ##    <chr>                      <chr>  <int>   <dbl>    <dbl>
    ##  1 The Fellowship Of The Ring Elf      971  NA       1.58  
    ##  2 The Fellowship Of The Ring Elf     1229  -0.267  NA     
    ##  3 The Fellowship Of The Ring Hobbit    14   0.326  NA     
    ##  4 The Fellowship Of The Ring Hobbit  3644  NA      -0.844 
    ##  5 The Fellowship Of The Ring Man        0   1.50   NA     
    ##  6 The Fellowship Of The Ring Man     1995  NA      -0.0244
    ##  7 The Return Of The King     Elf      183   0.152  NA     
    ##  8 The Return Of The King     Elf      510  NA      -2.11  
    ##  9 The Return Of The King     Hobbit     2  -0.432  NA     
    ## 10 The Return Of The King     Hobbit  2673  NA      -2.01  
    ## 11 The Return Of The King     Man      268   0.479  NA     
    ## 12 The Return Of The King     Man     2459  NA      -0.220 
    ## 13 The Two Towers             Elf      331  -1.11   NA     
    ## 14 The Two Towers             Elf      513  NA       1.09  
    ## 15 The Two Towers             Hobbit     0  -1.62   NA     
    ## 16 The Two Towers             Hobbit  2463  NA      -0.241 
    ## 17 The Two Towers             Man      401   0.783  NA     
    ## 18 The Two Towers             Man     3589  NA       2.05
